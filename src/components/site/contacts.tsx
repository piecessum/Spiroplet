      ...
      <div className="mx-auto max-w-6xl px-4 py-20 sm:px-6 lg:py-24">
        ...
        <div className="mt-12 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
          ...
          >
            ...
            <p className="mt-1 font-mono font-medium tracking-tight group-hover:underline">{contacts.email}</p>
          </a>
          ...
          >
            ...
            <p className="mt-1 font-mono font-medium tracking-tight group-hover:underline">{contacts.phone}</p>
          </a>
        ...
        <div className="mt-10 flex flex-wrap items-center gap-3">
          ...
          {socials.map((s) => (
            <a
              ...
              className="rounded-md border border-border bg-card px-3 py-1.5 font-mono text-sm font-medium tracking-tight transition-colors hover:bg-accent"
            >
              {s.name}
            </a>
          ))}
