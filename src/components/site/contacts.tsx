...
export function Contacts() {
  return (
    <section id="contacts" className="border-t border-border/60 bg-muted/40">
      <div className="mx-auto max-w-6xl px-4 py-20 sm:px-6 lg:py-24">
        ...
        <div className="mt-12 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
          <a
            ...
            className="group rounded-xl border border-border bg-background p-6 transition-colors hover:border-foreground/30"
          >
        ...
        <div className="mt-10 flex flex-wrap items-center gap-3">
          ...
          {socials.map((s) => (
            <a
              ...
              className="rounded-md border border-border bg-background px-3 py-1.5 text-sm font-medium transition-colors hover:bg-accent"
            >
              {s.name}
            </a>
          ))}
