...
export function Footer() {
  ...
  return (
    <footer>
      ...
      <div>
        <div className="mx-auto flex max-w-6xl flex-col gap-2 px-4 py-6 font-mono text-sm tracking-tight text-muted-foreground sm:flex-row sm:items-center sm:justify-between sm:px-6">
